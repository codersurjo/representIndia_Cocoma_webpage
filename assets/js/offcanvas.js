jQuery(document).ready(function(a) {
    ...
    (function() {
      ...
      (function() {
        ...
        c.length &&
          a(window).on("scroll", function() {
            a(this).scrollTop() > d
              ? (c.addClass("navbar-stuck"),
                c.hasClass("navbar-ghost") || b.css("padding-top", e))
              : (c.removeClass("navbar-stuck"), b.css("padding-top", 0));
          });
      })(),
      (function(b, c, d, e) {
      ...
      a(document).on("click", function(b) {
        a(b.target).closest(".lang-currency-switcher-wrap").length ||
          (a(".lang-currency-switcher-wrap").removeClass("show"),
        ...
        b.each(function() {
          ...
          d.keyup(function() {
            ...
            e.on("click", function(b) {
              var c = a(this).val();
              "all" !== c
                ? (f.hide(), a("[data-filter-item=" + c + "]").show())
                : f.show();
            });
        });
      })(a("[data-filter-list]")),
    ...
    if (void 0 !== l && null !== l) {
      ...
      noUiSlider.create(l, {
        ...
        l.noUiSlider.on("update", function(a, b) {
          var c = a[b];
          b
            ? ((s.innerHTML = Math.round(c)), (u.value = Math.round(c)))
            : ((r.innerHTML = Math.round(c)), (t.value = Math.round(c)));
        });
    }
          ...
          var d = function(b) {
                  ...
                  1 === c.nodeType &&
                    ...
                    c.children.length > 1 &&
                      (f.title = a(c)
                        ...
                        .html()),
                    d.children.length > 0 &&
                      (f.msrc = d.children[0].getAttribute("src")),
                    (f.el = c),
                    i.push(f));
              return i;
            },
            ...
            f = function(b) {
              ...
              if (f) {
                for (
                  var h,
                    i = f.closest(".gallery-wrapper"),
                    j = a(f.closest(".gallery-wrapper"))
                      .find(".gallery-item:not(.isotope-hidden)")
                      .get(),
                    k = j.length,
                    l = 0,
            ...
            marker: {
              ...
              events: {
                mouseover: function(b, c, d) {
                  ...
                  f
                    ? (f.open(e, b), f.setContent(d.data))
                    : a(this).gmap3({
                        infowindow: {
                          anchor: b,
                          options: {
